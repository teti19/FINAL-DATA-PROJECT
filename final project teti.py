...
#In this case March 14th, 2022
yesterday = datetime(2022, 3, 15)

# Spark References
SPARK_CODE = ("gs://us-central1-projectdata-0c7a1b10-bucket/spark/finalproject_spark.py")
...
with models.DAG(
    ...
    load_country_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        bucket="datafinalproject",
        source_objects=["STAGING/uscountry.parquet/part*"],
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.countries",
    ...
    load_port_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.ports",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_state_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.states",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_weather_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.weathers",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_demographic_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.demographic",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_airportcode_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.airport_codes",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
    ...
    load_immigration_to_bigquery = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table="final-project-teti:FINAL_PROJECT_STAGING.immigration_data",
        source_format="PARQUET",
        create_disposition="CREATE_IF_NEEDED",
        write_disposition="WRITE_TRUNCATE",
        autodetect=True,
